            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-24">
                    ...
                    <div className="space-y-8">
                        ...
                        <a href="mailto:info@oaklivebar.com" className="text-lg text-zinc-400 hover:text-primary transition-colors block">
                            info@oaklivebar.com
                        </a>
                        <div className="flex gap-6">
                            <a href="https://www.instagram.com/oaklivebar_official/?hl=en" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-zinc-900 rounded-full flex items-center justify-center hover:bg-primary hover:text-black transition-all">
                                <Instagram className="w-6 h-6" />
                            </a>
                            <a href="https://www.facebook.com/oaklivebar/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-zinc-900 rounded-full flex items-center justify-center hover:bg-primary hover:text-black transition-all">
                    ...
                    <div className="flex flex-col justify-end lg:items-end">
                        <div className="text-left lg:text-right">
                            <h4 className="text-zinc-500 font-bold text-[10px] uppercase tracking-[0.4em] mb-4">ESTABLISHED 2026</h4>
